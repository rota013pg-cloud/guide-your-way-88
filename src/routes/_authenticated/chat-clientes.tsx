...
import { operadorBroadcastCliente } from "@/lib/chat-cliente.functions";
...
import { Send, MessageSquare, RefreshCw, Trash2, Plus, ArrowLeft } from "lucide-react";
    ...
    <div className="p-3 lg:p-6">
      <div className="flex items-center justify-between mb-3 md:mb-4 gap-2">
        <h1 className="text-base md:text-2xl font-bold flex items-center gap-2 min-w-0">
          ...
          <span className="truncate">Chat clientes</span>
        </h1>
        <div className="flex items-center gap-1 md:gap-2 shrink-0">
          ...
          <BroadcastDialog
            publico="clientes"
            onEnviar={(texto) => operadorBroadcastCliente({ data: { texto } })}
          />
              ...
              >
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="font-semibold text-sm md:text-base truncate">{selecionado} - {conversaAtual?.cliente_nome}</div>
                ...
                {isAdmin && (
                  ...
                  >
                    ...
                    <span className="hidden md:inline">{apagandoConversa ? "Apagando..." : "Apagar conversa"}</span>
                  </Button>
                )}
              </div>
