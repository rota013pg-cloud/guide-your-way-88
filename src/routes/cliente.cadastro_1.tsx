...
import { cpfValido, telefoneCelularValido, nomeCompletoValido } from "@/lib/validacao-cadastro";
...
function ClienteCadastroPage() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    // Veracidade do cadastro (mesma regra do banco) — segurança dos motociclistas.
    ...
    if (!telefoneCelularValido(form.telefone)) {
      toast.error("Telefone celular inválido — informe um número real com DDD.");
      return;
    }
    setLoading(true);
    try {
